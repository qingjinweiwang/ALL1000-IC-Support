...
#define DPIDR             (0x0BC11477L)    /* STM32G0 Cortex-M0+ */

#define FLASH_BASE         0x08000000L
#define FLASH_SIZE         0x00010000L
#define FLASH_PAGE_SIZE    0x00000800L

#define TOTAL_PAGE  	   32

#define FALSH_APP_BASE     0x08000000L
...
#define FLASH_BLANK_WORD     0xFFFFFFFFL
...
static uChar VerifyOptionRegistersAll(uInt32 optr, uInt32 wrp1ar, uInt32 wrp1br, uChar errorCode);
