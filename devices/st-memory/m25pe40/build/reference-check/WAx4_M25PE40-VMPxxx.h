...
const uShort Block_M25PE40VMPxxx[] = 
{
    ...
    0x0000,0x0000, 0x0007,0xFFFF,         /* Virtual data range: 00000000h-0007FFFFh */

    /**************** Main Flash ****************/
    0x0000,0x0007,0xFFFF,                 /* attr / checksum mask / blank value */
...
{ /* Typical   ParaType  Scale          MinVal     MaxVal      ParaName */
	...
	330,		VCCH,	x10mV,		270,		360,		NounVCCH,
	330,		VCCL,	x10mV,		270,		360,		NounVCCL,
	330,		VIH,		x10mV,		270,		360,		NounVIH,	/* VIH Volts MUST be same with FPGA Pin Type Setting!! */
...
{
///////// 3.3V ///////////////////////
	{ AlgoIdx_M25PE40, BlkIdx_M25PE40VMPxxx, SpcIdx_3V3, PmpIdx_H3V3SO8UG4A, AlgoIC_0x00}, /* M25PE40-VMPxxx */
	/* here adding more... */
};
...
{ /* Table Sequence by Block/Sector Index Code Constant Define */
	11,  /* BULK ERASE cycle time：8-10s */
} ;
