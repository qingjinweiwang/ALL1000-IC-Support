...
Version: 1.0	MCU
Version: 1.2	STM32G030F6P6 测试版（SWD 协议栈重构）
Version: 1.3	STM32G030F6P6 正式版
...
const uChar DrvElement_Table[][5] =
{
	...
	{ AlgoIdx_SWD, BlkIdx_32K, SpcIdx_LV33, PmpIdx_P3V3SWD_Easyfpga, AlgoIC_0x01 }, /* STM32G071K8T3*/
	/* here adding more... */
};
